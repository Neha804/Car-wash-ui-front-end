  ...
  <div class="container py-5">
    <div class="row h-100 align-items-center py-5">
      <div class="col-lg-6">
        ...
        <p class="lead text-muted mb-0">We are a highly motivated team</p>
        <p class="lead text-muted">On a mission to ease your Car Wash.
        </p>
      </div>
...
<div class="bg-white py-5">
  <div class="container py-5">
    <div class="row align-items-center mb-5">
      <div class="col-lg-6 order-2 order-lg-1"><i class="bi bi-bar-chart fa-2x mb-3 text-primary"></i>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6"><i class="bi bi-leaf fa-2x mb-3 text-primary"></i>
        <h2 class="font-weight-light">Lorem ipsum dolor sit amet</h2>
        <p class="font-italic text-muted mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><a href="#" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
      </div>
    </div>

...
import './Register.css';
import washerRegister from "../services/auth.service";
...
export const RegisterWasher = () => {
    ...
    return (
        ...
        <div className='row'style={{ marginTop: "10px", paddingBottom:"10px"}}>
            ...
            <div className='Register container col-md-5' style={{ width: "50%", paddingBottom:"10px"}}>

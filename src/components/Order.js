...
import getWasherByEmail from "../services/auth.service";
import postOrder from "../services/auth.service";
...
export const Order = () => {
  ...
  const calculation = useMemo(() => HandleChange(), [cost]);
              ...
              <input type="text" class="form-control" id="address" placeholder="full address of washer" value={pack}/> */}
                ...
                {toggleVar && <div>
                  <div className='row mt-4 p-5 bg-dark text-white rounded'>
                    ...
                    <div className='container'>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="basePackage" value="2000" onClick={()=>{setPackage1(!package1);setPackage2(false);setPackage3(false);SetShowAddons(true);HandleChange();}}/>
                        <label class="form-check-label" for="basePackage">Base Package</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="premiumPackage" value="4000" onClick={()=>{setPackage2(!package2);setPackage1(false);setPackage3(false);SetShowAddons(true);HandleChange();}}/>
                        <label class="form-check-label" for="premiumPackage">Premium Package</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="vipPackage" value="10000" onClick={()=>{setPackage3(!package3);setPackage1(false);setPackage2(false);SetShowAddons(true);HandleChange();}}/>
                  ...
                  {showAddons && <div className='row mt-4 p-5 bg-secondary text-white rounded'>
                    ...
                    <div className='container'>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="Tyrepolish" value="500" onClick={(e)=>{setAddon1(!addon1);HandleChange();}}/>
                        <label class="form-check-label" for="Tyrepolish">Tyre polish</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="MotorWash" value="1500" onClick={(e)=>{setAddon2(!addon2);HandleChange();}}/>
                        <label class="form-check-label" for="MotorWash">Motor Wash</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="InteriorDesigning" value="2500" onClick={(e)=>{setAddon3(!addon3);HandleChange();}}/>
